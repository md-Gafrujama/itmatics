/** First-party cookie consent + analytics payload helpers for ITmatics News. */

export const CONSENT_COOKIE = "itm_consent";
export const VID_COOKIE = "itm_vid";
export const ATTR_COOKIE = "itm_attr";
