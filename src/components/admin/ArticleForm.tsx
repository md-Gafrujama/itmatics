    ...
    <form action={action}>
      ...
      <div className="admin-card">
        ...
        <div className="field">
          ...
          />
          <span className="field-hint">
            Max {SEO_LIMITS.keywords} characters. Example: cloud FinOps,
        ...
        <div className="field">
          ...
          <input
            ...
            placeholder="Keyword first, end with | ITmatics News"
          />
        </div>
        <div className="field">
        ...
        <div className="seo-preview" aria-hidden>
          ...
          <p className="seo-preview-url">itmaticsnews.com › article › slug</p>
      ...
      <div className="admin-card">
        ...
        <div style={{ display: "flex", gap: 8 }}>
          <input
            placeholder="Search Pexels, e.g. 'data center cloud'"
            value={pexelsQuery}
